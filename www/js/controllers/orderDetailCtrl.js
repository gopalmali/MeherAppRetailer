    ...
    .controller('orderDetailCtrl', function($http,$scope,OrderData,$location,$ionicPopup) {
      ...
      $scope.showAcceptAlert = function() {
        $ionicPopup.alert({
          ...
          template: '3 items accepted.Pls delivery good quality in time for best ratings'
        });
      ...
      $scope.showAcceptConfirm= function() {
        $ionicPopup.confirm({
          title: 'Conformation of details',
          template: 'Are you sure you want to REJECT these orders?',
